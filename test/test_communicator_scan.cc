...
BOOST_AUTO_TEST_CASE(scan) {
  ...
  BOOST_TEST(scan_test(mplr::plus<double>(), 1.0));
  BOOST_TEST(scan_test(mplr::plus<tuple>(), tuple{1, 2.0}));
  ...
  BOOST_TEST(scan_test_with_layout(mplr::plus<double>(), 1.0));
  BOOST_TEST(scan_test_with_layout(mplr::plus<tuple>(), tuple{1, 2.0}));
  ...
  BOOST_TEST(iscan_test(mplr::plus<double>(), 1.0));
  BOOST_TEST(iscan_test(mplr::plus<tuple>(), tuple{1, 2.0}));
  ...
  BOOST_TEST(iscan_test_with_layout(mplr::plus<double>(), 1.0));
  BOOST_TEST(iscan_test_with_layout(mplr::plus<tuple>(), tuple{1, 2.0}));
  ...
  BOOST_TEST(scan_test_inplace(mplr::plus<double>(), 1.0));
  BOOST_TEST(scan_test_inplace(mplr::plus<tuple>(), tuple{1, 2.0}));
  ...
  BOOST_TEST(scan_test_with_layout_inplace(mplr::plus<double>(), 1.0));
  BOOST_TEST(scan_test_with_layout_inplace(mplr::plus<tuple>(), tuple{1, 2.0}));
  ...
  BOOST_TEST(iscan_test_inplace(mplr::plus<double>(), 1.0));
  BOOST_TEST(iscan_test_inplace(mplr::plus<tuple>(), tuple{1, 2.0}));
  ...
  BOOST_TEST(iscan_test_with_layout_inplace(mplr::plus<double>(), 1.0));
  BOOST_TEST(iscan_test_with_layout_inplace(mplr::plus<tuple>(), tuple{1, 2.0}));
